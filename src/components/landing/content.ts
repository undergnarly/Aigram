...
const PRICE_RANGES = {
  planner: { from: "$189/mo", delivery: { en: "24h setup", ru: "24ч настройка" } },
  researcher: { from: "$189/mo", delivery: { en: "24h setup", ru: "24ч настройка" } },
  automator: { from: "$449/mo", delivery: { en: "24h setup", ru: "24ч настройка" } },
  analyst: { from: "$449/mo", delivery: { en: "24h setup", ru: "24ч настройка" } },
  developer: { from: "$449/mo", delivery: { en: "24h setup", ru: "24ч настройка" } },
  concierge: { from: "$1,499/mo", delivery: { en: "48h setup", ru: "48ч настройка" } },
};
...
const EN: LangContent = {
  ...
  hero: {
    eyebrow: "Your AI team, inside Telegram.",
    h1Lines: ["Run your business", "from one", "Telegram group"],
    lead:
      "A specialist for every job — Plans, Research, Leads, Calendar. Each remembers its own context and works 24/7. No new app, no foreign card, no VPN — live on your server in 24 hours. From $189/mo.",
      ...
      tiers: [
        {
          ...
          price: "$189/mo",
          delivery: "24h setup",
          features: ["Basic plans + tasks", "Smart reminders", "2 users", "Default boards"],
        },
        {
          name: "Standard",
          price: "$449/mo",
          delivery: "24h setup",
          features: ["Everything in Starter", "Voice capture", "5 users", "Custom boards"],
          highlight: true,
        },
        {
          name: "Pro",
      ...
      tiers: [
        {
          ...
          price: "$189/mo",
          delivery: "24h setup",
          features: ["Daily research briefs", "Web scraping (50 pages/day)", "2 users", "Archive search"],
        },
        {
          name: "Standard",
          price: "$449/mo",
          delivery: "24h setup",
          features: ["Everything in Starter", "OSINT + dossiers", "5 users", "Voice query"],
          highlight: true,
        },
        {
          name: "Pro",
      ...
      tiers: [
        {
          ...
          price: "$189/mo",
          delivery: "24h setup",
          features: ["3 workflows", "Lead processing", "2 users", "Daily report"],
        },
        {
          name: "Standard",
          price: "$449/mo",
          delivery: "24h setup",
          features: ["Everything in Starter", "10 workflows", "5 users", "Voice triggers"],
          highlight: true,
        },
        {
          name: "Pro",
      ...
      tiers: [
        {
          ...
          price: "$189/mo",
          delivery: "24h setup",
          features: ["Daily KPI digest", "5 connected tools", "2 users", "Basic mini-app"],
        },
        {
          name: "Standard",
          price: "$449/mo",
          delivery: "24h setup",
          features: ["Everything in Starter", "Anomaly alerts", "5 users", "Standard mini-app"],
          highlight: true,
        },
        {
          name: "Pro",
      ...
      tiers: [
        {
          ...
          price: "$189/mo",
          delivery: "24h setup",
          features: ["3 small tasks / month", "Landing pages + simple integrations", "2 users", "Public repo"],
        },
        {
          name: "Standard",
          price: "$449/mo",
          delivery: "24h setup",
          features: ["Everything in Starter", "Unlimited tasks", "5 users", "Private repo + Netlify deploys"],
          highlight: true,
        },
        {
          name: "Pro",
  ...
  features: {
    ...
    items: [
      {
        tag: "Templates",
        title: "25+ topic templates — install in one tap",
  ...
  pricing: {
    ...
    sub: "Start free for 14 days — no card. Starter $189/mo (5 topics, solo). Standard $449/mo (12 topics, 5 users). Pro $799/mo (25 topics + Opus). Agency $1,499/mo (unlimited + white-label).",
    productTab: "Topic",
    ...
    note: "Prices in USD. International invoicing available. Builders: self-host on your own API key — Hacker $79/mo. Larger or custom deployments — book a Discovery Call.",
  },
  faq: {
    eyebrow: "FAQ",
    ...
    items: [
      ...
      },
      {
        ...
        a: "Starter runs on GLM — fast and cost-efficient for planning and research. Standard adds Claude Sonnet (with Haiku and GLM as automatic fallback). Pro and Agency unlock Claude Opus as the primary model, with Sonnet, Haiku, and GLM beneath it. You always get the best model available within your plan.",
      },
      {
      ...
      },
      {
        ...
        a: "ChatGPT is a single conversation thread — no persistent memory between sessions, no real tools, no team access. GramFleet gives you a whole team of specialists — one inside each topic, 25+ to pick from — each remembering everything since day one, running 40+ live skills (web scraping, code execution, calendar, KPI reports), with your whole team working alongside them at once. It's the difference between one generalist intern and a trained department that never forgets.",
      },
      {
  ...
  finalCta: {
    ...
    sub: "Tell us about your business — we set up your topic structure on your server and have you running before this time tomorrow. No card, cancel anytime.",
    ...
    submitting: "Sending…",
    success: "You're in.",
    successSub: "We'll confirm your setup within one business day. Watch your inbox.",
    ...
    items: [
      {
        ...
        plan: "Fits Standard ($449/mo, up to 12 topics)",
      },
      {
      ...
      },
      {
        ...
        plan: "Fits Starter ($189/mo, up to 5 topics)",
      },
    ],
  },
  subscriptionPlan: {
    ...
    plans: [
      {
        ...
        includes: [
          ...
          "Voice — 30 generations / mo (input + reply)",
      ...
      },
      {
        ...
        includes: [
          "Up to 12 topics",
          "Pick from 25+ topic templates",
          "Claude Sonnet + Haiku + GLM auto-fallback",
          "5 users",
          "40+ built-in skills",
    ...
    compatRows: [
      ...
      { module: "Users", starter: "2", standard: "5", pro: "15", agency: "Unlimited" },
      { module: "Topics", starter: "5", standard: "12", pro: "25", agency: "Unlimited" },
      { module: "Custom skills", starter: "—", standard: "3", pro: "6", agency: "Unlimited" },

      { kind: "section", label: "AI & interface" },
      { module: "AI model", starter: "GLM", standard: "Claude Sonnet + Haiku + GLM", pro: "Claude Opus + Sonnet + Haiku + GLM", agency: "All models" },
      { module: "Built-in skills", starter: "20+", standard: "40+", pro: "40+", agency: "40+" },
      { module: "Voice messages", starter: "30 / mo", standard: "Unlimited", pro: "Unlimited + custom voice", agency: "Unlimited + custom voice" },
  ...
  differentiators: {
    ...
    rows: [
      ...
      { label: "Price range", values: ["$189-1,499", "$49-99", "Free (DIY)", "$30"] },
    ],
...
const RU: LangContent = {
  ...
  hero: {
    eyebrow: "Твоя AI-команда — прямо в Telegram.",
    h1Lines: ["Управляй бизнесом", "из одной", "Telegram-группы"],
    lead:
      "Специалист под каждую задачу — Plans, Research, Leads, Calendar. Каждый помнит свой контекст и работает 24/7. Без нового приложения, без иностранной карты и VPN — поднимаем на твоём сервере за 24 часа. От $189/мес.",
      ...
      tiers: [
        {
          ...
          price: "$189/мес",
          delivery: "24ч",
          features: ["Базовые планы и задачи", "Умные напоминания", "2 пользователя", "Готовые доски"],
        },
        {
          name: "Standard",
          price: "$449/мес",
          delivery: "24ч",
          features: ["Всё из Starter", "Голосовой ввод", "5 пользователей", "Кастомные доски"],
          highlight: true,
        },
        {
          name: "Pro",
      ...
      tiers: [
        {
          ...
          price: "$189/мес",
          delivery: "24ч",
          features: ["Ежедневные брифы", "Парсинг 50 страниц/день", "2 пользователя", "Поиск по архиву"],
        },
        {
          name: "Standard",
          price: "$449/мес",
          delivery: "24ч",
          features: ["Всё из Starter", "OSINT и досье", "5 пользователей", "Голосовые запросы"],
          highlight: true,
        },
        {
          name: "Pro",
      ...
      tiers: [
        {
          ...
          price: "$189/мес",
          delivery: "24ч",
          features: ["3 процесса", "Обработка лидов", "2 пользователя", "Ежедневный отчёт"],
        },
        {
          name: "Standard",
          price: "$449/мес",
          delivery: "24ч",
          features: ["Всё из Starter", "10 процессов", "5 пользователей", "Голосовые триггеры"],
          highlight: true,
        },
        {
          name: "Pro",
      ...
      tiers: [
        {
          ...
          price: "$189/мес",
          delivery: "24ч",
          features: ["Ежедневный дайджест KPI", "5 подключений", "2 пользователя", "Базовое мини-приложение"],
        },
        {
          name: "Standard",
          price: "$449/мес",
          delivery: "24ч",
          features: ["Всё из Starter", "Алерты по аномалиям", "5 пользователей", "Стандартное мини-приложение"],
          highlight: true,
        },
        {
          name: "Pro",
      ...
      tiers: [
        {
          ...
          features: ["3 небольшие задачи в месяц", "Лендинги и простые интеграции", "2 пользователя", "Публичный репозиторий"],
        },
        {
          name: "Standard",
          price: "$449/мес",
          delivery: "24ч настройка",
          features: ["Всё из Starter", "Без лимита задач", "5 пользователей", "Приватный репозиторий + Netlify-деплои"],
          highlight: true,
        },
        {
          name: "Pro",
  ...
  features: {
    ...
    items: [
      {
        tag: "Шаблоны",
        title: "25+ шаблонов топиков — ставятся за один тап",
  ...
  pricing: {
    ...
    sub: "14 дней бесплатно — без карты. Starter $189/мес (5 топиков, соло). Standard $449/мес (12 топиков, 5 пользователей). Pro $799/мес (25 топиков + Opus). Agency $1 499/мес (без лимита + white-label).",
    productTab: "Топик",
    ...
    note: "Цены в USD. Международное выставление счетов. Для билдеров: self-host на своём API-ключе — Hacker $79/мес. Большие или кастомные проекты — звонок.",
  },
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Starter работает на GLM — быстро и экономично для планирования и ресёрча. Standard добавляет Claude Sonnet (с Haiku и GLM в авто-fallback). Pro и Agency открывают Claude Opus как основную модель, с Sonnet, Haiku и GLM в резерве. Ты всегда получаешь лучшую модель в рамках своего тарифа.",
      },
      {
  ...
  finalCta: {
    ...
    h2: "Запустите 14-дневный бесплатный триал.",
    sub: "Расскажите о бизнесе — настроим структуру топиков на вашем сервере и запустим до завтрашнего вечера. Без карты, отмена в любой момент.",
    ...
    submit: "Начать бесплатный триал",
    submitting: "Отправляем…",
    success: "Записали.",
    successSub: "Подтвердим настройку в течение рабочего дня. Ждите письмо.",
    ...
    items: [
      {
        ...
        title: "Growth HQ",
        topics: ["Plans", "Content", "Research", "Leads"],
        plan: "Подходит под Standard ($449/мес, до 12 топиков)",
      },
      {
      ...
      },
      {
        ...
        title: "Personal HQ",
        topics: ["Plans", "Finance", "Health", "Habits", "Diary"],
        plan: "Подходит под Starter ($189/мес, до 5 топиков)",
      },
    ],
  },
  subscriptionPlan: {
    ...
    plans: [
      {
        ...
        includes: [
          ...
          "Голос — 30 генераций/мес (ввод + ответ)",
      ...
      },
      {
        ...
        monthlyPrice: "$449 / мес",
        buildTime: "24ч",
        includes: [
          "До 12 топиков",
          "Выбор из 25+ шаблонов топиков",
          "Claude Sonnet + Haiku + GLM (авто-fallback)",
          "5 пользователей",
          "40+ готовых навыков",
    ...
    compatRows: [
      ...
      { module: "Пользователи", starter: "2", standard: "5", pro: "15", agency: "Без лимита" },
      { module: "Топики", starter: "5", standard: "12", pro: "25", agency: "Без лимита" },
      { module: "Кастомные скиллы", starter: "—", standard: "3", pro: "6", agency: "Без лимита" },

      { kind: "section", label: "ИИ и интерфейс" },
      { module: "AI-модель", starter: "GLM", standard: "Claude Sonnet + Haiku + GLM", pro: "Claude Opus + Sonnet + Haiku + GLM", agency: "Все модели" },
      { module: "Готовые навыки", starter: "20+", standard: "40+", pro: "40+", agency: "40+" },
      { module: "Голосовые сообщения", starter: "30 / мес", standard: "Без лимита", pro: "Без лимита + кастомный голос", agency: "Без лимита + кастомный голос" },
  ...
  differentiators: {
    ...
    rows: [
      ...
      { label: "Russian-friendly", values: ["✅", "⚠️", "❌", "✅"] },
      { label: "Цена", values: ["$189-1,499", "$49-99", "Free (DIY)", "$30"] },
    ],
